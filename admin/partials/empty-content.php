		<form id="form_empty_wordpress_content" method="post">
			<?php wp_nonce_field( 'empty', 'fgd2wp_nonce' ); ?>
			...
			<table class="form-table">
				<tr>
					...
					<td><input type="radio" name="empty_action" id="empty_action_imported" value="imported" /> <label for="empty_action_imported"><?php _e('Remove only new imported data', 'fg-drupal-to-wp'); ?></label><br />
					...
					<?php submit_button( __('Empty WordPress content', 'fg-drupal-to-wp'), 'primary', 'empty' ); ?></td>
				</tr>
			</table>
		</form>
